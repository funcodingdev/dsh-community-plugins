 ...
 *
 * The pluginhub's `activation[name].state` is an inference drawn from the
 ...
 * pluginhub against itself. This marker is ground truth instead.
 *
...
export const name = 'dsph-e2e-fixture-clash'
