/**
 * Optional host-provided agent inventory: lets the pluginhub refuse plugin
 ...
 * implementation with different wording fails open (the pluginhub stays
...
export function runningAgentIds(agents: AgentsServiceLike | undefined): string[] {
  ...
  try {
    ...
    // A half-disposed registry must never take the pluginhub's routes down.
    return []
  }
