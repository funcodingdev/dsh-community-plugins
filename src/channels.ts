/**
 * The pluginhub's release channels: which build of ITSELF it offers.
 *
 * Only the pluginhub follows this. Other plugins are never pulled from a
 * prerelease on the strength of a setting the user made about the pluginhub —
...
/** A channel the pluginhub can follow. */
 ...
 * `dsh-community-plugins@beta` by hand IS the subscription, and treating that as
 ...
 * pluginhub answers "up to date" and the next beta is never offered.
 *
