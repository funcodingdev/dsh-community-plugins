...
import { analyzeProfile, compareSemver, type CheckOptions, type DuplicateName, type PeerRisk, type PeerWarning, type PeerVerdict } from './check.ts'
...
/** Evaluate the current profile with the shared composition analysis. */
